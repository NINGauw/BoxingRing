...
public class EnemyAIController : MonoBehaviour
{
    ...
    public float minAttackDelay = 3.0f; // Time tối thiểu giữa các đợt tấn công
    public float maxAttackDelay = 6.0f; // Time tối đa giữa các đợt tấn công
    private float attackTimer;

    [Header("Enemy Attack Stats")]
    public float leftPunchDamage = 1f;
    public float rightPunchDamage = 1f;
    public float upperPunchDamage = 1f;
    public float straightPunchDamage = 0.5f;
